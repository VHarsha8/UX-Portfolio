        ...
        <div className="flex flex-col gap-10 my-20 mx-auto md:px-0 px-6 md:w-[800px]">
            <style>
                {`
                    .mesh-pattern {
                        ...
                        mask-image: linear-gradient(360deg, transparent, rgba(0, 0, 0, 0.5) 20%, rgba(0, 0, 0, 0.8) 60%, black);
            ...
            <div className="grid items-center justify-center gap-4 md:grid-cols-3 md:flex-row">
                <div className="relative grid gap-3 p-6 border shadow-lg bg-white/5 backdrop-blur-lg border-white/20 rounded-xl">
                    ...
                    <h1 className="z-10 text-3xl font-medium text-white font-playfair">UX Research</h1>
                ...
                <div className="relative grid gap-3 p-6 border shadow-lg bg-white/5 backdrop-blur-lg border-white/20 rounded-xl">
                    ...
                    <h1 className="z-10 text-3xl font-medium text-white font-playfair">UI Design</h1>
                    <p className='text-sm text-gray-400 font-space-mono'>Creating beautiful, intuitive interfaces that engage and guide users effortlessly.</p>
                </div>
                <div className="relative grid gap-3 p-6 border shadow-lg bg-white/5 backdrop-blur-lg border-white/20 rounded-xl">
                    <div className="mesh-pattern"></div>
                    <img src="/prototype.png" alt="UI Design" className="z-10 w-12 h-12 mb-2" />
                    <h1 className="z-10 text-3xl font-medium text-white font-playfair">Prototyping</h1>
                    <p className='text-sm text-gray-400 font-space-mono'>Developing interactive prototypes to test and refine user experiences early on</p>
                </div>
            </div>
        </div>
    );
