...
const Projects1 = () =>{
    return(
        <div className='md:w-[800px] md:px-0  overflow-hidden relative p-6 mt-6 bg-blue-800/10 border border-white/10 rounded-2xl mx-4 md:mx-auto md:flex-row-reverse flex flex-col  '>
