...
const Projects = () =>{
    return(
        <div className='md:w-[800px] md:p-0 overflow-hidden  relative p-6 mt-6 bg-black border border-white/30 rounded-2xl mx-4 md:mx-auto md:flex-row-reverse flex flex-col  '>
