...
const Projects = () =>{
    return(
        <div className='md:w-[800px] md:p-0 overflow-hidden  relative p-6 mt-6 bg-blue-500/20 border border-white/10 rounded-2xl mx-4 md:mx-auto md:flex-row-reverse flex flex-col  '>
